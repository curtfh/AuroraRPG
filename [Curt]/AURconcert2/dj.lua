...
function loadDJPanel()
	...
	djmain_window = guiCreateWindow(windowX, windowY, windowWidth, windowHeight, "Aurora ~ DJ Center", false)
...
addCommandHandler("djmixer", handlePanel)
...
addEventHandler("NGCconcert.playmus", root, function ( url, plr )
	...
	setSoundMaxDistance(stream, 2000)
