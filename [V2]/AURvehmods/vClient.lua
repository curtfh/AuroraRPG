...
addEventHandler("onClientResourceStart", resourceRoot,
    function()
        panel = guiCreateWindow(229, 146, 763, 542, "AuroraRPG  - Vehicles Mods Panel", false)
...
addEvent ("userpanel_vehmods", true )
addEventHandler ("userpanel_vehmods", root, vehModsCmd )
                ...
                if ( fileExists("mods/"..txd) ) then
                    if ( state == false ) then
                        ...
                        if ( weirdbool ) then
                            ...
                            exports.NGCdxmsg:createNewDxMessage("Another mod already enabled at the same vehicle.", 255, 0, 0 )
                            return end
