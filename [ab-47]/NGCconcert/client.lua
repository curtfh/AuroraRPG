...
function checkResolutionOnStart ()
	...
	if (x <= 640) and (y <= 480) then
		outputChatBox ("WARNING: You are running on a low resolution. It's possible you will not see the concert features!", 255, 0, 0)
	end
end
...
function loadDJPanel()
	...
	djmain_labelx = guiCreateLabel(15, 27, 496, 35, "NGC DJ Center", false, djmain_window)
...
addCommandHandler("opendj", handlePanel)
