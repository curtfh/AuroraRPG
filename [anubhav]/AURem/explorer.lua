...
addEvent("AURevents.SendElements", true)
addEventHandler("AURevents.SendElements", root, onReceiveElements)
...
function deleteElementFunc()
	...
	if (element) then
		triggerServerEvent("AURevents.DeleteElement", root, element)
	end
end
