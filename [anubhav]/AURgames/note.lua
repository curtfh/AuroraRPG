...
function addEventMsg(id, text, r, g, b, timer)
	if not id then id = "addEventMsg" end
...
addEvent("addEventMsg", true)
addEventHandler("addEventMsg", root, addEventMsg)
