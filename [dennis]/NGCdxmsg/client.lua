...
addEventHandler("onClientRender", root,
	function()
		for _,bar in ipairs(ContextBar.entries) do
			...
			if not bar.r and not bar.g and not bar.b then
				bar.r, bar.g, bar.b = 255,0,0
			end
			dxDrawBorderedText(bar.text, 0, bar.y, gScreen.x, bar.y + ContextBar.height, tocolor(bar.r, bar.g, bar.b, math.lerp(0, 255, bar.alpha)), 1, "default-bold", "center", "center", true, true, true,math.lerp(0, 255, bar.alpha))
