...
-- Window
shopWindow = guiCreateWindow(437,249,477,457,"AuroraRPG ~ 24/7 shop",false)
...
irgoggleImage = guiCreateStaticImage(253,30,68,67,"images/IRGOGGLES.png",false,shopWindow)
irgoggleButton = guiCreateButton(241,102,97,36,"Infrared Goggles ($1000)",false,shopWindow)
nightgoggleImage = guiCreateStaticImage(373,30,70,74,"images/NVGOGGLES.png",false,shopWindow)
nightgoggleButton = guiCreateButton(361,102,97,36,"Night Goggles ($1000)",false,shopWindow)
flowersImage = guiCreateStaticImage(139,153,67,69,"images/FLOWERS.png",false,shopWindow)
flowersButton = guiCreateButton(127,228,97,36,"Flowers ($300)",false,shopWindow)
fireImage = guiCreateStaticImage(372,154,66,66,"images/FIREEXT.png",false,shopWindow)
fireButton = guiCreateButton(358,228,97,36,"Fire Extinguisher ($1500)",false,shopWindow)
parashuteImage = guiCreateStaticImage(19,275,69,66,"images/PARACHUTE.png",false,shopWindow)
parashuteButton = guiCreateButton(9,340,97,36,"Parachute ($1000)",false,shopWindow)
dildoImage = guiCreateStaticImage(136,275,68,60,"images/DILDO1.png",false,shopWindow)
dildoButton = guiCreateButton(123,340,97,36,"Dildo ($500)",false,shopWindow)
viberatorImage = guiCreateStaticImage(253,153,66,66,"images/VIBE1.png",false,shopWindow)
viberatorButton = guiCreateButton(241,228,97,36,"Vibrator ($600)",false,shopWindow)

closeScreen = guiCreateButton(190,400,97,36,"Close Shop Window",false,shopWindow)
...
addEventHandler("onClientGUIClick", fireButton, function() exports.NGCdxmsg:createNewDxMessage("You can not buy it",255,0,0) end, false)
