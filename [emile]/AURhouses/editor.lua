houseEditWindow = guiCreateWindow(575,304,272,388,"AUR ~ Edit House",false)
...
function doUpdateHouse ()
	...
	elseif tonumber(price) < 50000 then
		outputChatBox("You cant create a house with a price under the $50,000.", 225, 0, 0)
