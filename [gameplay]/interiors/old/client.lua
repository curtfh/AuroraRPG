...
addEventHandler ( "doWarpPlayerToInterior",localPlayer,
	function ( interior, resource, id )
		...
		exports.NGCdxmsg:createNewDxMessage("You can't enter an interior when tazed",255,0,0)
		return false end
		if exports.server:isPlayerDamaged(localPlayer) then
		exports.NGCdxmsg:createNewDxMessage("You can't enter an interior because you are just health effected.",255,0,0)
		return false end
		if getElementData(localPlayer,"armor",true) then
		exports.NGCdxmsg:createNewDxMessage("You can't enter an interior with the armor",255,0,0)
		return false end
