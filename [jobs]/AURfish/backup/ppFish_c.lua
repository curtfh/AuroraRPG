...
------------------------------------------------------------------------------------
	...
	windowFishInv = guiCreateWindow(left, top, windowWidth, windowHeight, "New Gaming Community ~ Fishing", false)
	...
	gui["listFishInv_col2"] = guiGridListAddColumn(gui["listFishInv"], "NGC Record (Kg)", 0.243666)
...
GUIEditor_Image = {}
guiFishShop={}
guiFishShop[1] = guiCreateWindow(0.401,0.3143,0.3229,0.2371,"NGC ~ Fish Shop",true)
...
GUIEditor_Memo[1] = guiCreateMemo(0.4964,0.1593,0.4431,0.3681,"-----------Selling Fish---------\nWelcome to the NGC Fish Shop! To sell your fish, :\n1. Press F5 or type /fish.\n2. Select your fish.\n3. Press Sell.\n4. You could get a bonus\nif you have a fisherman rank!",true,guiFishShop[1])
guiMemoSetReadOnly(GUIEditor_Memo[1],true)
GUIEditor_Memo[2] = guiCreateMemo(0.4964,0.544,0.4431,0.3626,"-----------Permits---------\nWelcome to the NGC Fish Shop! A Permit works on a per fish basis. A permit lets you fish without the fisherman job, if you fish without the fisherman job, and without the permit, you will get wanted for illegal fishing.",true,guiFishShop[1])
...
function updateInv(bool)
	...
	if permits then
		guiSetText(windowFishInv,"New Gaming Community ~ Fishing :: Permit - "..permits.."")
		else
		guiSetText(windowFishInv,"New Gaming Community ~ Fishing")
	end
...
function showShop()
	...
	showCursor(true)
	 exports.DENdxmsg:createNewDxMessage("Welcome to the NGC Fish Shop! You can sell your fish here.",0,255,0)
end
