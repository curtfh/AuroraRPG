...
function ToggleLaserEnabled(cmd)
	...
	if tonumber(percent) > 2 then
		if IsLaserEnabled(player) == false then
			...
			exports.NGCdxmsg:createNewDxMessage("Laser: Equipped and turned on",0,255,0)
		else
			SetLaserEnabled(player, false)
			exports.NGCdxmsg:createNewDxMessage("Laser: Unequipped and turned off",0,255,0)
		end
	end
end
