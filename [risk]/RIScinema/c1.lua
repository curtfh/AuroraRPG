local currentURL = "http://aurorarvg.com"
...
addCommandHandler("watchcinema",function()
	...
	watching = false
	removeEventHandler("onClientRender", root, webBrowserRender)
	outputChatBox("You are no longer watching: "..currentURL, 255, 255, 255)
	elseif(not watching)then
	watching = true
	addEventHandler("onClientRender", root, webBrowserRender)
	outputChatBox("You are now watching: "..currentURL, 255, 255, 255)
	end
end)